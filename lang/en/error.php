...
$string['hashpoolproblem'] = 'Incorrect pool file content {$a}: mismatching size for the file just moved into the pool. Incorrect file permissions or disk space issues?';
$string['hashpoolalreadyexistsproblem'] = 'File content already in the pool {$a->contenthash}, size conflict: file in the pool => {$a->poolfilesize}, file to be added => {$a->currfilesize}.';
$string['hashpoolfilesizeproblem'] = 'Incorrect pool file content {$a}: the given hash doesn\'t match the given file.';
