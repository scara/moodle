...
class core_setuplib_testcase extends advanced_testcase {
     ...
     */
    public function is_valid_uuid_v4($value) {
    ...
    /**
     * Test the generate_uuid_via_php_uuid_extensions() function.
     */
    public function test_generate_uuid_via_php_uuid_extensions() {
        if (!extension_loaded('uuid')) {
            $this->markTestSkipped("PHP 'uuid' extension not loaded.");
        }
        $uuid = generate_uuid_via_php_uuid_extensions();
        $this->assertTrue($this->is_valid_uuid_v4($uuid), "Invalid v4 uuid: '$uuid'");
    }

    /**
     * Test the generate_uuid_via_random_bytes() function.
     */
    public function test_generate_uuid_via_random_bytes() {
        if (!function_exists('random_bytes')) {
            $this->markTestSkipped("PHP function 'random_bytes' not available.");
        }
