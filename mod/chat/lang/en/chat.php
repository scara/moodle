...
$string['configserverenablesecureaccess'] = 'Enable a secure access via HTTPS to the server daemon. A secure tunneling must be already configured.';
...
$string['configserversecureport'] = 'Port to use on the server for the daemon secure access';
...
$string['serverenablesecureaccess'] = 'Enable the secure access';
$string['serverhost'] = 'Server name';
$string['serverip'] = 'Server ip';
$string['servermax'] = 'Max users';
$string['serverport'] = 'Server port';
$string['serversecureport'] = 'Server secure access port';
